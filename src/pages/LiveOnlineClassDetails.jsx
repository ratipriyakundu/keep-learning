...
export default function LiveOnlineClassDetails() {
            ...
            <div className="col-md-6 w-100">
              ...
              <div className="px-5 mb-5 review-section">
                <div className="d-flex justify-content-between align-items-center mt-5 mb-4">
                  ...
                  <h6 onClick={handleShow} className="add-review-plus">
                    + Add Review
                  </h6>
                </div>
        ...
        <Modal.Body>
          <form className="loginform">
            <div className="form-group mt-3">
              <label className="text-center d-block mb-4" htmlFor="review">
                <h4>Rate Us & Write a Review</h4>
              </label>
              <div className="text-center mb-3">
                <img src="../../img/Star 2.svg" alt=".." width="5%" />
                <img src="../../img/Star 2.svg" alt=".." width="5%" />
                <img src="../../img/Star 2.svg" alt=".." width="5%" />
                <img src="../../img/Star 2.svg" alt=".." width="5%" />
                <img src="../../img/Star 5.svg" alt=".." width="5%" />
              </div>
              <textarea id="review" className="form-control mt-1"></textarea>
            </div>
            <div className="text-center">
              <button
                type="button"
                className="btn custom-btn m-auto btn-lg btn-block mt-4 py-2"
              >
                Submit
              </button>
            </div>
