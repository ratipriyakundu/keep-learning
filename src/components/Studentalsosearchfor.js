                ...
                return (
                  <SwiperSlide key={index}>
                    <div className="member-slider-wrap ">
                      ...
                      >
                        <h2 style={{ color: props.cardTitleColor, lineHeight: '30px' }}>
                          {item.title}
                        </h2>
                        <p style={{ color: props.cardTitleDetailsColor }}>
                          {item.about.length > 60 ? item.about.substring(0, 60) : item.about}
                        </p>
                        <div className="row">
                          <div className="Corse d-flex justify-content-center align-items-center">
                            ...
                            <p style={{ color: props.durationColor }}>₹ {item.courseFee}</p>
                          </div>
